...
export class Icons extends HTMLElement {
  ...
  static ICONS: Record<string, string> = {
    ...
    book: this.TMPL_BOOK,
    delete: this.TMPL_DELETE,
    update: this.TMPL_UPDATE,
    list: this.TMPL_LIST,
    start: this.TMPL_START,
    cache: this.TMPL_CACHE,
    search: this.TMPL_SEARCH,
    info: this.TMPL_INFO,
  };
