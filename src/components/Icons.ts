...
`);
  ...
  static ICONS: Record<string, HTMLTemplateElement> = {
    logout: Icons.TMPL_LOGOUT,
    home: Icons.TMPL_HOME,
    admin: Icons.TMPL_ADMIN,
    book: Icons.TMPL_BOOK,
    delete: Icons.TMPL_DELETE,
    update: Icons.TMPL_UPDATE,
